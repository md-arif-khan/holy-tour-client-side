            ...
            <div class="-mx-4 flex flex-wrap lg:justify-between">
              <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
                <div class="mb-12 max-w-[570px] lg:mb-0">
                  ...
                  A Contact Us page is essential for your site to engage with visitors and customers. Check out these helpful tips and contact us page examples.
                  </p>
                  ...
                  <div class="mb-8 flex w-full max-w-[370px]">
                    ...
                    <div class="w-full">
                      ...
                      <p class="text-body-color text-base">(+88)01314868578</p>
                    </div>
                  </div>
                  <div class="mb-8 flex w-full max-w-[370px]">
                    <div
                    ...
                    <div class="w-full">
                      ...
                      <p class="text-body-color text-base">mdarifkhan8578@gmail.com</p>
                    </div>
                  </div>
                </div>
              </div>
