...
const PaymentMethod = () => {
    return (
            ...
            <div class="bg-gradient-to-b mb-4 from-[#101212] relative to-[#08201D]">
        ...
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 relative z-20">
            <div class="max-w-xl mx-auto text-center">
                <h1 class="text-3xl font-bold sm:text-6xl">
                    <span class="text-transparent bg-clip-text bg-gradient-to-r from-green-300 to-white"> Simplified Payment </span>
                </h1>
                <p class="mt-5 text-base text-white sm:text-xl">It allows a transaction recipient to prove that the sender has control of the source funds of the payment they are offering without downloading the full Blockchain, by utilising the properties of Merkle proofs</p>
                ...
                <div class="grid grid-cols-1 px-20 mt-12 text-left gap-x-12 gap-y-8 sm:grid-cols-3 sm:px-0">
                    <div class="flex items-center">
                        ...
                        <p class="ml-3 text-sm text-white">Over 12,000 visitor joined</p>
                    </div>
